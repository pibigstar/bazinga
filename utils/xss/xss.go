...
func (mw *XssMw) callRemoveXss(c *ghttp.Request) {
	// Bluemonday Policy
	if mw.BmPolicy == "" {
...
//
func (mw *XssMw) XssRemove(c *ghttp.Request) error {
...
func (mw *XssMw) HandleGETRequest(c *ghttp.Request) error {
...
//
func (mw *XssMw) HandleXFormEncoded(c *ghttp.Request) error {
...
func (mw *XssMw) HandleMultiPartFormData(c *ghttp.Request, ctHdr string) error {
...
//}
//
func (mw *XssMw) HandleJson(c *ghttp.Request) error {
...
func (mw *XssMw) SetRequestBodyJson(c *ghttp.Request, buff bytes.Buffer) error {
